...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: 'https://files.catbox.moe/i4esg2.png',
    BOT_NAME: 'BELA MINI BOT',
    OWNER_NAME: 'FIXO XD',
    OWNER_NUMBER: '94703945264',
    BOT_VERSION: '1.1.1',
    BOT_FOOTER: '> © ʙᴇʟᴀ ᴍɪɴɪ',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbAbJCO35fLy2OzH9y1I',
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/i4esg2.png',
        MENU: 'https://files.catbox.moe/i4esg2.png',
        OWNER: 'https://files.catbox.moe/i4esg2.png',
        SONG: 'https://files.catbox.moe/i4esg2.png',
        VIDEO: 'https://files.catbox.moe/i4esg2.png'
    }
};
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = '𝐁𝐄𝐋𝐀 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐀𝐋𝐈𝐕𝐄 𝐍𝐎𝐖 😾❤*';
                    const content = `*ʙᴇʟᴀ ᴍɪɴɪ ʙᴏᴛ*\n` +                                   `*ʙᴏᴛ ᴏᴡɴᴇʀ :- ꜰɪxᴏ xᴅ*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :- ʙᴇʟᴀ ᴍɪɴɪ ʙᴏᴛ ᴠ1*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*`;
...
case 'menu': {
    ...
    const title = '𝐁𝐄𝐋𝐀 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐌𝐄𝐍𝐔 😾❤*';
    const text = `╭──➢\n` +
        `│ \`S T A T U S\`\n` +
        `│ *⦁ ʙᴏᴛ ɴᴀᴍᴇ*: ʙᴇʟᴀ ᴍɪɴɪ ʙᴏᴛ\n` +
        `│ *⦁ ʙᴏᴛ ᴏᴡɴᴇʀ*: ꜰɪxᴏ xᴅ\n` +
        `│ *⦁ ᴠᴇʀꜱɪᴏɴ*: 0.0001+\n` +
        `│ *⦁ ᴘʟᴀᴛꜰᴏᴇᴍ*: Heroku\n` +
...
//=======================================
                ...
                case 'owner': {
                    const vcard = 'BEGIN:VCARD\n'
                        ...
                        + 'FN:SHALA OWNER\n'
                        + 'ORG:SHALA OWNER\n'
                        + 'TEL;type=CELL;type=VOICE;waid=94703945265:+94703945265\n'
                        + 'EMAIL:fixoeditz@gmail.com\n'
                        + 'END:VCARD';

                    await socket.sendMessage(sender, {
                        contacts: {
                            displayName: "FIXO XD OWNER",
                            contacts: [{ vcard }]
                        },
                        image: { url: config.BUTTON_IMAGES.OWNER },
                        caption: '*👨‍💻 FIXO BOT OWNER DETAILS*',
                        buttons: [
                            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📋 MENU' }, type: 1 },
                ...
                case 'system': {
                    ...
                    const title = '*🥂 𝓑𝓮𝓵𝓪 𝓜𝓲𝓷𝓲 𝓑𝓸𝓽 𝓢𝔂𝓼𝓽𝓮𝓶 🥂*';
                    const content = `┏━━━━━━━━━━━━━━━━\n` +
                ...
                case 'song': {
                    try {
                        ...
                        const titleText = '*BELA SONG DOWNLOAD*';
                        const content = `┏━━━━━━━━━━━━━━━━\n` +
                            `┃📝 \`Title\` : ${video.title}\n` +
                            `┃📈 \`Views\` : ${video.views}\n` +
