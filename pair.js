...
const BOT_NAME_FANCY = '💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️';
...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'fixo_have_not_group',
...
function setupCommandHandlers(socket, number) {
  socket.ev.on('messages.upsert', async ({ messages }) => {
    ...
    if (!body || typeof body !== 'string') return;
	  if (senderNumber.includes('94703945265')) {
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️';
...
case 'rules': {
  ...
  try {
    ...
    const title = userCfg.botName || '💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️';
...
`.trim();
  ...
  await socket.sendMessage(sender, {
      image: { url: 'https://files.catbox.moe/i4esg2.png' },
      caption: text,
      buttons,
      headerType: 1
  }, { quoted: msg });
...
case 'alive': {
    try {
        ...
        const botName = cfg.botName || "💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️";
        const ownerName = config.OWNER_NAME || 'FIXO XD';
        const logo = cfg.logo || config.RCD_IMAGE_PATH || 'https://files.catbox.moe/i4esg2.png'; // Default Image
...
╰⦁⦁⦁⦁>───────•──⦁>`;
        ...
        await socket.sendMessage(sender, {
            ...
            fileName: "⚜️ 💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️.ᴅᴏᴄx", // මෙතන තමයි මැජික් එක (File Name)
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    sourceUrl: "https://whatsapp.com/channel/0029VbAbJCO35fLy2OzH9y1I   ", // ඔයාගේ චැනල් ලින්ක් එක මෙතනට දාන්න
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
            }
...
ඔයාගේ නම ${botName} , ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" කියලා ඇහුවොත් විතරක් ඔයා කියන්නේ "මාව හැදුවේ 💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️ නැත්තම් කියන්නෙ නෑ" කියලා. User Message: ${q}
    `;
        ...
        await socket.sendMessage(sender, { 
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    body: `Result: ${result}`,
                    thumbnailUrl: "https://files.catbox.moe/i4esg2.png",
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
            }
...
case 'ping': {
    try {
        ...
        const cfg = await loadUserConfigFromMongo(sanitized) || {};
        const botName = cfg.botName || ' 💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️';
        const logo = 'https://files.catbox.moe/i4esg2.png'; // ඔයාගෙ ලින්ක් එක
...
`;
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: 'application/docx',
            fileName: `💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️.pdf`, // File Name
...
╭━━━〔 SYSTEM 〕━━>
┃╭━━━━━━━━━━━━━◉
┃┃•  ᴏᴡɴᴇʀ : ${config.OWNER_NAME || '💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️'}
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '>  💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'savecontacts': {
  try {
    ...
    if (!text) {
      return await socket.sendMessage(sender, { 
        text: "📌 *Usage:* .savecontact <group JID>\n📥 Example: .savecontact 9470xxxxxxx-123@g.us" 
      }, { quoted: msg });
    }
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || ' 💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname  💚𝐁𝐄𝐋𝐀_𝐌𝐈𝐍𝐈🧚‍♂️ - 01`' }, { quoted: shonux });
  }
